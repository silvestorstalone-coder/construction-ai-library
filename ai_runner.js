/**
 * ai_runner.js
 * Полностью рабочий вариант для Node.js 24
 * Автообновление SYSTEM_PIPELINE.md через Яндекс GPT
 */
...
function getPipeline() {
  if (!fs.existsSync('SYSTEM_PIPELINE.md')) return "";
  return fs.readFileSync('SYSTEM_PIPELINE.md', 'utf8');
}

// ====================
// Функция: запрос к Яндекс GPT с повтором
// ====================
...
Форматировать как markdown, сохранить стиль документа.
`;
